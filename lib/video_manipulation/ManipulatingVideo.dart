...
class ManipulatingVideo extends StatefulWidget {
  const ManipulatingVideo({
    Key? key,
  }) : super(key: key);

  @override
  State<ManipulatingVideo> createState() => _ManipulatingVideoState();
}

class _ManipulatingVideoState extends State<ManipulatingVideo> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: const VideoPickerPage(),
    );
  }
}
